...
import logging
import glob
from misc.TiffTileLoaderIron import TiffTileLoader
import numpy as np
from lxml import etree as ET
import  export_heatmap_metadata  as exp_meta
import skimage.transform as xform
import nibabel as nib
from HeatmapCreatorIron import  HeatmapCreator as hc
...
class ColormapCreator(object):
    ...
    def __init__(self,name,root_dir=None,dir_list=None):
        ...
        #default values
        self.PIX_1MM = 131  # 1mm= 819 pixels
        self.PIX_5MM = 655  # 5mm = 4095 pixels
        self.HMAP_RES = 0.1
